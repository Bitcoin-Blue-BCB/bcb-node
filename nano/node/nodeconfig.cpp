...
std::string const default_live_peer_network = nano::get_env_or_default ("NANO_DEFAULT_PEER", "peering.bitcoinblue.app");
	...
	external_address{ boost::asio::ip::address_v6{}.to_string () }
{
	...
	switch (network_params.network.network ())
	{
		...
		case nano::networks::nano_live_network:
			...
			preconfigured_representatives.emplace_back ("4040810C5A1AF8ACAA9E1E63D97DF846515C3263885A00DB240E85FDC20A3CB8");
			break;
